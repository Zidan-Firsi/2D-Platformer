...
public class EnemyController : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        else if (col.gameObject.CompareTag("Peluru")) // Menambahkan logika untuk peluru
        {
            TakeDamage(1); // Misalnya damage 1
            Destroy(col.gameObject); // Menghancurkan peluru setelah mengenai musuh
        }
    }
